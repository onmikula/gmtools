...
# imagename - function modifying image names (identity by default)
# prefix - a character string to be added to image name prior to modification by imagename
# extension - file extension to be added to image name


writeTPS <- function(X, file, sliders=NULL, missing=-1, imagename=identity, prefix=NULL, extension=NULL) {
	...
	images <- paste0("IMAGE=", prefix, imagename(names(X)))
